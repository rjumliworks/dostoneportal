...
return new class extends Migration
{
    ...
    {
        Schema::table('asset_equipment_records', function (Blueprint $table) {
            $table->string('maintainable_type')->nullable()->after('id');
            $table->integer('maintainable_id')->unsigned()->nullable()->after('maintainable_type');
        });

        DB::table('asset_equipment_records')->update([
        ...
        Schema::table('asset_equipment_records', function (Blueprint $table) {
            ...
            $table->index(['maintainable_type', 'maintainable_id'], 'asset_maintenance_records_maintainable_index');
        });
    ...
    {
        Schema::table('asset_equipment_records', function (Blueprint $table) {
            $table->integer('equipment_id')->unsigned()->nullable()->after('id');
        });
        ...
        Schema::table('asset_equipment_records', function (Blueprint $table) {
            $table->dropIndex('asset_maintenance_records_maintainable_index');
