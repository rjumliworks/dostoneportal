...
class ShowClass
{
    ...
    public function travel($code){
        ...
        $data = RequestSignatory::with([
            ...
            'request.travel.events.types','request.travel.events.audience','request.travel.events.mode',
            'request.travel.events.request.location.region:code,name,region','request.travel.events.request.location.province:code,name','request.travel.events.request.location.municipality:code,name','request.travel.events.request.location.barangay:code,name',
            'request.travel.events.request.dates',
            'request.comments.user.profile:user_id,firstname,middlename,lastname,avatar,suffix_id','request.comments.replies.user.profile:user_id,firstname,middlename,lastname,avatar,suffix_id',
            'request.tags.user:id',
            'request.tags.user.profile:user_id,firstname,middlename,lastname,avatar,suffix_id',
