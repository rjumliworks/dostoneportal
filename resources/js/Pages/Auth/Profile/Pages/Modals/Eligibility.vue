        ...
        <form class="customform">
            <BRow class="g-3 mt-n1">
                <BCol lg="12">
                    ...
                    <TextInput v-model="form.exam_name" type="text" class="form-control" placeholder="e.g. Career Service Examination (Professional)" @input="handleInput('exam_name')" :light="true" />
                </BCol>
                <BCol lg="6">
