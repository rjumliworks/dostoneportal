                ...
                <div class="card-header bg-light-subtle">
                    <div class="d-flex mb-n3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="text-muted text-truncate-two-lines fs-12">List of IAR Chairperson and Members</p>
                        </div>
...
export default {
    ...
    computed: {
        ...
        chairperson() {
            return this.committeeDesignations.find(d => d.designation === 'IAR Chairperson')
                || this.buildPlaceholder('IAR Chairperson');
        },
        members() {
            const members = this.committeeDesignations.filter(d => d.designation === 'IAR Member');

            return this.withPlaceholders(members, 3, 'IAR Member');
        }
    },
    methods: {
