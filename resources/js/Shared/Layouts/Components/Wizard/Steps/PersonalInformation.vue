<template>
    <div>
        <h5 class="fs-14 text-primary mb-3">Personal Information</h5>
        <form class="customform">
            <BRow class="g-3">
                <BCol lg="4">
                    <InputLabel value="Username"/>
                    <TextInput :model-value="username" type="text" class="form-control" readonly :light="true"/>
                </BCol>
                <BCol lg="4">
                    <InputLabel value="Email Address"/>
                    <TextInput :model-value="email" type="text" class="form-control" readonly :light="true"/>
                </BCol>
                <BCol lg="4">
                    <InputLabel value="Agency Employee No."/>
                    <TextInput v-model="form.agency_employee_no" type="text" class="form-control" @input="clearError('agency_employee_no')" :light="true"/>
                </BCol>
                <BCol lg="4">
                    <InputLabel value="Date of Birth" :message="form.errors.birthdate"/>
                    <TextInput v-model="form.birthdate" type="date" class="form-control" @input="clearError('birthdate')" :light="true"/>
                </BCol>
                <BCol lg="4">
                    <InputLabel value="Place of Birth" :message="form.errors.place_of_birth"/>
                    <TextInput v-model="form.place_of_birth" type="text" class="form-control" placeholder="e.g. Zamboanga City" @input="clearError('place_of_birth')" :light="true"/>
                </BCol>
                <BCol lg="4">
                    <InputLabel value="Contact No." :message="form.errors.mobile"/>
                    <TextInput v-model="form.mobile" type="text" class="form-control" @input="clearError('mobile')" :light="true"/>
                </BCol>
                <BCol lg="3">
                ...
                <BCol lg="3">
                    ...
                    <TextInput v-model="form.height" type="number" class="form-control" placeholder="e.g. 1.65" @input="clearError('height')" :light="true"/>
                </BCol>
                <BCol lg="3">
                    <InputLabel value="Weight (kg)" :message="form.errors.weight"/>
                    <TextInput v-model="form.weight" type="number" class="form-control" @input="clearError('weight')" :light="true"/>
                </BCol>
                <BCol lg="12" class="mt-2"><hr class="text-muted mb-2"/></BCol>
                <BCol lg="12">
    ...
    data(){
        ...
        return {
            form: useForm({
                ...
                agency_employee_no: profile.agency_employee_no ?? null,
                option: 'personal'
            }),
        }
    },
    computed: {
        username(){ return this.$page.props.user.data.username; },
